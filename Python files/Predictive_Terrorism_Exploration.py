...
plt.show()
# Split data into features (X) and target variable (y)
X_multiclass = combined_df.drop(columns=['success'])
y_multiclass = combined_df['success']  # Adjust the target variable according to your classification task
...
# Split data into training and testing sets
X_train_multiclass, X_test_multiclass, y_train_multiclass, y_test_multiclass = train_test_split(X_multiclass, y_multiclass, test_size=0.3, random_state=42)
